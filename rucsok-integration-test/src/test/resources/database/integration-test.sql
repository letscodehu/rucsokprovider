...
values (1, 'rucsok like no tomorrow', 1, 1, null, '2016-08-08 12:12:12');
insert into comment(id, text, user_id, rucsok_id, parent_id, createdAt)
values (2, 'tunaktunaktun', 2, 1, 1, '2016-08-08 13:13:13');
insert into comment(id, text, user_id, rucsok_id, parent_id, createdAt)
values (3, 'who let the rucsok out?', 1, 1, 1, '2016-08-08 14:14:14');
insert into comment(id, text, user_id, rucsok_id, parent_id, createdAt)
values (4, 'gonna delete this', 2, 1, null, '2016-08-08 15:15:15');

insert into comment(id, text, user_id, rucsok_id, parent_id, createdAt)
values (5, 'rucs it up', 1, 1, null, '2016-08-18 12:12:12');

insert into comment(id, text, user_id, rucsok_id, parent_id, createdAt)
values (6, 'rucs it up2', 1, 1, null, '2016-08-18 12:12:15');

insert into comment(id, text, user_id, rucsok_id, parent_id, createdAt)
values (7, 'rucs it up3 best sequel', 1, 1, null, '2016-08-20 12:12:15');
